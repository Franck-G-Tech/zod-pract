...
export default function TodoForm() {
    ...
    const handleUpgrade = async () => {
        ...
        try {
            ...
            setError("No se pudo conectar con Stripe. Intenta de nuevo."+ (err instanceof Error ? err.message : "Error desconocido"));
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (errorMessage.includes("LIMIT_REACHED")) {
                setError("😧¡Límite alcanzado!😥 😎😏obtener el Plan Pro😉👌😌");
                setShowUpgrade(true); 
            } else {
